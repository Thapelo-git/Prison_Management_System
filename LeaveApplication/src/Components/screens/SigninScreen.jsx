...
const SigninScreen = ({navigation}) => {
   ...
   visible={modalopen}>
       ...
       <View style={styles.headerContainer} 
            ...
            <Image source={require('../assets/Images/Company_icon.png')} style={{width:120,height:100}}/>
            </View>
    ...
    height:deviceHeight * 0.7}}>
        ...
        width:250,height:60,backgroundColor:'gainsboro',borderRadius:30}}>
            ...
            onPress={()=>setPage(0)}>
                  <Text style={{color:page===0?'#fff':'#000',fontWeight:'bold'}}>Employee</Text>
              </TouchableOpacity>
        ...
        width:'100%'}}>
            {
                page === 0?(<FamilySignIn navigation={navigation}/>):(null)
            }
            {
                page === 1?(<PoliceSignin navigation={navigation}/>):(null)
            }
